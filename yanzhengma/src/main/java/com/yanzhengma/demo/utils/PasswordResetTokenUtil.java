...
public class PasswordResetTokenUtil {
	...
	private static final String SECRET = "MySecretKeyForPasswordReset_2025"; // 生产环境请用更安全的方式管理
    ...
    public String getEmailFromToken(String token) {
        try {
            Claims claims = Jwts.parserBuilder()
                    .setSigningKey(SIGNING_KEY) // ✅ 使用 SecretKey，不是字符串！
                    .build()
